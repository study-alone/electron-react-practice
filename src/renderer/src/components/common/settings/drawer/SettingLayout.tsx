import { styled, alpha, RadioGroup, Grid, CardActionArea, Box, Stack } from '@mui/material'
...
const VerticalBox = ({ isSelected }: VerticalBoxProps) => {
	return (
		<>
			<Box
				sx={{
...
const HorizontalBox = ({ isSelected }: HorizontalBoxProps) => {
	return (
		<>
			<Box
				sx={{
